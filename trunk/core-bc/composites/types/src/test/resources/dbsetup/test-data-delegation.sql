...
insert into vgr_delegation (id, status, signToken, delegatedBy, created)
 values (-3,'PENDING','','delegatedBy','2011-10-01 12:00:00.0');
insert into vgr_delegation (id, status, signToken, delegatedBy, created)
 values (-4,'REJECTED','','delegatedBy','2011-10-01 11:30:00.0');
-- delegateBy, delegateFor2
insert into vgr_delegation (id, status, signToken, delegatedBy, created)
 values (-5,'PENDING','','delegatedBy','2011-10-01 12:00:00.0');
...
insert into vgr_delegation (id, status, signToken, delegatedBy, created, approvedOn)
 values (-7,'ACTIVE','signToken','delegatedBy2','2011-09-08 10:00:00.0','2011-09-08 11:00:00.0');
-- delegateBy3, delegateFor3
insert into vgr_delegation (id, status, signToken, delegatedBy, created)
 values (-8,'REJECTED','','delegatedBy3','2011-10-01 12:00:00.0');
-- delegateBy4, delegateFor3
insert into vgr_delegation (id, status, signToken, delegatedBy, created)
 values (-9,'PENDING','','delegatedBy4','2011-10-01 12:00:00.0');

-- delegationBy, delegateFor - SUPERSEDED
insert into vgr_delegation_to (id, delegation_id, delegatedFor, delegateto, validFrom)
 values (-1,-1,'delegatedFor','apa','2011-09-01 11:00:00.0');
insert into vgr_delegation_to (id, delegation_id, delegatedFor, delegateto, validFrom, validTo)
...
-- delegationBy, delegateFor - PENDING
insert into vgr_delegation_to (id, delegation_id, delegatedFor, delegateto, validFrom, validTo)
 values (-6,-3,'delegatedFor','bepa','2011-11-05 11:00:00.0','2011-11-15 11:00:00.0');
insert into vgr_delegation_to (id, delegation_id, delegatedFor, delegateto)
 values (-7,-3,'delegatedFor','cepa');
-- delegationBy, delegateFor - REJECTED
insert into vgr_delegation_to (id, delegation_id, delegatedFor, delegateto)
 values (-8,-4,'delegatedFor','cepa');
-- delegationBy, delegateFor2 - PENDING
insert into vgr_delegation_to (id, delegation_id, delegatedFor, delegateto, validFrom)
