 ...
 */
@ContextConfiguration(locations = {"/META-INF/JettyTestRouteBuilder-configuration.xml"})
public class JettyTestRouteBuilderTest extends AbstractJUnit4SpringContextTests {
